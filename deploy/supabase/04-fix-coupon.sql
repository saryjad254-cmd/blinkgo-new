-- ════════════════════════════════════════════════════════════════
-- Fix Bug: "record 'v_coupon' is not assigned yet"
--       + "function name is not unique"
--
-- 📍 نسخ من هنا إلى ────────────────────────────────
-- ════════════════════════════════════════════════════════════════

-- 🗑️ احذف كل النسخ القديمة أولاً (كل signature محتمل)
...
-- ════════════════════════════════════════════════════════════════
-- ✅ الآن أنشئ الجديد (بدون OR REPLACE لأنه تم حذف الكل)
-- ════════════════════════════════════════════════════════════════
...
BEGIN
  ...
  -- ═══════════════════════════════════════════════════════════════
  -- ✅ FIX: كوبون بـ scalar variables (لا RECORD)
  -- ═══════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════
-- ✅ اختبار: يجب أن يُرجع صف واحد فقط بدون خطأ
-- ════════════════════════════════════════════════════════════════
SELECT
