...
import { haversineDistance, haversineKm, formatDistance, type LatLng } from '@/lib/delivery-zone';
...
// Re-exports — single canonical source: `@/lib/delivery-zone`.
export { haversineDistance, haversineKm, formatDistance, type LatLng } from '@/lib/delivery-zone';
