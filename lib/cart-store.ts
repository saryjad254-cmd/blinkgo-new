...
export const useCart = create<CartState>()(
  persist(
    ...
    {
      name: 'blinkgo-cart',
      // Bumped from 1 → 2 to refresh older localStorage payloads that may have
      // missing fields (e.g. restaurant_lat / restaurant_lng used for distance
      // computation) so the canonical schema is enforced.
      version: 2,
