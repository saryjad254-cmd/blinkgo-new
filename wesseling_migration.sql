-- Wesseling Delivery Zone
-- Run this in Supabase SQL Editor: https://supabase.com/dashboard/project/rhdaffhlrglyknxtucux/sql
...
-- 7. Insert Wesseling radius zone (covers entire ~23 km² city)
INSERT INTO public.delivery_zones (
  name, description, center_lat, center_lng, radius_km,
  delivery_fee, min_order_amount, priority, is_active
) VALUES (
...
-- 8. Insert Wesseling polygon zone (precise boundaries)
INSERT INTO public.delivery_zones (
...
-- 9. Verify
SELECT * FROM public.delivery_zones ORDER BY priority DESC;
