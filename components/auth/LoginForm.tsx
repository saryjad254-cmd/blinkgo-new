          ...
          <div className="relative">
            ...
            <input
              ...
              className={cn(
                ...
                errors.email
                  ? 'border-danger focus:border-danger focus:ring-2 focus:ring-danger/40 focus:shadow-[0_0_0_3px_rgba(239,68,68,0.12)]'
                  : 'border-edge focus:border-brand focus:bg-bg-subtle focus:ring-2 focus:ring-brand/40 focus:shadow-[0_0_0_3px_rgba(255,107,26,0.12)]'
              )}
