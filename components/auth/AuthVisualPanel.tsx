...
const COPY: Record<Locale, {
  ...
  de: {
    ...
    subtitle: 'Bestellen Sie aus Ihren Lieblingsläden und erleben Sie Premium-Lieferung auf Knopfdruck.',
    features: [
      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        >
          <div className="flex items-center gap-1 mb-2">
            ...
            <span className="text-xs text-text-muted ml-1.5">4.9 · 12,847 reviews</span>
          </div>
