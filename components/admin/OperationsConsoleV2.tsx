        ...
        <div className="flex flex-col sm:flex-row gap-2">
          <div className="relative flex-1">
            ...
            <input
              ...
              aria-label="Fahrer oder Restaurant suchen"
              className="w-full h-11 ps-10 pe-3 rounded-xl bg-bg-card border-2 border-ink-3/30 text-sm focus:outline-none focus:ring-2 focus:ring-ink-3/50"
            />
          </div>
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-2 mb-1">
        <span className="text-sm font-semibold text-ink-1 truncate flex-1">{r.name}</span>
