  ...
  return (
    ...
    >
      <div className="relative aspect-[16/10] overflow-hidden bg-bg-secondary">
        ...
        />
        {r.is_promoted && (
          <span className="absolute top-2 left-2 px-2 py-0.5 bg-brand-gradient text-white text-xs font-semibold rounded-full">
            {t.promoted || 'Promoted'}
          </span>
        )}
      ...
      <div className="p-3 space-y-1.5">
        <div className="flex items-center gap-1.5">
          <h3 className="font-semibold text-text-primary truncate flex-1">{r.name}</h3>
          {r.is_featured && (
