...
const COPY = {
  de: {
    title: '✨ Bald auch in Ihrer Gegend',
    subtitle: 'Entschuldigung — wir haben Ihre Adresse noch nicht erreicht.',
    body: 'BlinkGo wächst ständig. Wir freuen uns darauf, bald auch Ihre Gegend zu bedienen.',
    where: 'Sagen Sie uns, wo Sie BlinkGo haben möchten.',
    address: 'Adresse',
    ...
    successDesc: 'Wir benachrichtigen Sie, sobald wir Ihre Gegend beliefern.',
    distance: 'Entfernung',
    away: 'Sie sind ca. {km} km außerhalb unserer aktuellen Lieferzone.',
  ...
  return (
    <div dir={dir} className="min-h-screen bg-bg relative overflow-hidden flex items-center justify-center px-4 py-8">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-0 right-0 w-[500px] h-[500px] rounded-full bg-brand-yellow-500/15 blur-[120px]" />
