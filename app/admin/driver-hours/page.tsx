                        ...
                        <div className="flex items-center gap-3">
                          <div className="flex-1">
                            ...
                            <input
                              ...
                              className="w-full px-3 py-2 rounded-md bg-bg border border-edge-light text-white focus:border-brand-red-500 focus:ring-2 focus:ring-brand-red-500/40 focus:outline-none"
                            />
                          </div>
