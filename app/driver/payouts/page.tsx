...
const COPY = {
  de: { title: 'Auszahlungen', total: 'Gesamt', pending: 'Ausstehend', paid: 'Bezahlt', deliveries: 'Lieferungen', period: 'Zeitraum', reference: 'Referenz', emptyTitle: 'Noch keine Auszahlungen', emptyDesc: 'Deine wöchentlichen Auszahlungen erscheinen hier nach deiner ersten Lieferwoche.' },
  ar: { title: 'المدفوعات', total: 'الإجمالي', pending: 'معلقة', paid: 'مدفوعة', deliveries: 'التوصيلات', period: 'الفترة', reference: 'المرجع', emptyTitle: 'لا توجد مدفوعات بعد', emptyDesc: 'ستظهر مدفوعاتك الأسبوعية هنا بعد أول أسبوع من التوصيل.' },
  en: { title: 'Payouts', total: 'Total', pending: 'Pending', paid: 'Paid', deliveries: 'Deliveries', period: 'Period', reference: 'Reference', emptyTitle: 'No payouts yet', emptyDesc: 'Your weekly payouts will appear here after your first week of deliveries.' },
};
